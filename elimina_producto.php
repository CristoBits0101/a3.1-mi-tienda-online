...
if (isset($_GET['id']) && !isset($_GET['confirm'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Producto eliminado correctamente.'); window.location.href = 'listado_productos.php';</script>";
    } else {
        echo "<script>alert('Hubo un error al eliminar el producto.'); window.history.back();</script>";
    }
    $stmt = null; 
    $conn = null; 
    exit;
...
<div class="container">
    ...
    <form action="elimina_producto.php" method="post">
        <label for="producto">Seleccione el producto que desea eliminar:</label><br>
